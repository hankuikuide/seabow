...
public class ShiroConfig {
    ...
    /*@Bean
    public DbShiroRealm authorizeShiroRealm() {
        DbShiroRealm authorizeShiroRealm = new DbShiroRealm();
        return authorizeShiroRealm;
    }

    @Bean
    public SecurityManager securityManager() {
        DefaultWebSecurityManager securityManager = new DefaultWebSecurityManager();
        securityManager.setRealm(authorizeShiroRealm());
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        // 配置不会被拦截的链接 顺序判断
        // anon:所有url都都可以匿名访问,在shiro的配置文件中放行swagger
